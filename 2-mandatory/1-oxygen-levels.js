...
function safeLevels(array) {
  let oxygenLevels = array.map(element => element.replace("%", ""));
  let findFirstSafeLevel = oxygenLevels.find(oxygenLevel => oxygenLevel > 19.5 && oxygenLevel < 23.5);
  return findFirstSafeLevel + "%";
}
